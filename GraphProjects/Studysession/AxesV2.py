...
ax[0, 0].plot(year, One_piece, color='red', marker="o");
ax[0, 1].plot(year, Naruto, color='blue', marker="o");
ax[1, 0].plot(year, Bleach, color='green', marker="o");
ax[1, 1].plot(year, DragonBall, color='orange', marker="o");
